...
/** \mainpage RoboComp::chochaloca
 *
 * \section intro_sec Introduction
 *
 * The chochaloca component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/chochaloca --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
#define PROGRAM_NAME    "chochaloca"
#define SERVER_FULL_NAME   "RoboComp chochaloca::chochaloca"
...
class chochaloca : public Ice::Application
{
public:
	chochaloca (QString configFile, QString prfx, bool startup_check) { 
...
Ice::InitializationData chochaloca::getInitializationDataIce(){
...
int chochaloca::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	chochaloca app(configFile, prefix, startup_check_flag);
